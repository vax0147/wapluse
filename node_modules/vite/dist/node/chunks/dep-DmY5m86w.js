...
var require_parse = __commonJS({ "../../node_modules/.pnpm/postcss-value-parser@4.2.0/node_modules/postcss-value-parser/lib/parse.js"(exports, module) {
	...
	module.exports = function(input) {
		...
		while (pos < max) if (code <= 32) {
			...
			else if ((uLower === token.charCodeAt(0) || uUpper === token.charCodeAt(0)) && pluse$1 === token.charCodeAt(1) && isUnicodeRange.test(token.slice(2))) tokens.push({
				type: "unicode-range",
				sourceIndex: pos,
				sourceEndIndex: next,
				value: token
...
var require_unit = __commonJS({ "../../node_modules/.pnpm/postcss-value-parser@4.2.0/node_modules/postcss-value-parser/lib/unit.js"(exports, module) {
	...
	module.exports = function(value) {
		...
		if ((code === exp || code === EXP) && (nextCode >= 48 && nextCode <= 57 || (nextCode === pluse || nextCode === minus) && nextNextCode >= 48 && nextNextCode <= 57)) {
			pos += nextCode === pluse || nextCode === minus ? 3 : 2;
			while (pos < length) {
				code = value.charCodeAt(pos);
				if (code < 48 || code > 57) break;
				pos += 1;

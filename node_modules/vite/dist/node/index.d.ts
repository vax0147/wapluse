...
interface DepOptimizationConfig {
   ...
   * common chunks. If all dependencies are found by the scanner pluse the explicitly
...
interface DepOptimizationMetadata {
  ...
  configHash: string;
  /**
   * The browser hash is determined by the main hash pluse additional dependencies
